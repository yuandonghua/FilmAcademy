package com.xingguangedu.myxg.http;
...
public class UserDataHttp {
     ...
     * @param code 验证码
     * @param handler
     * @param success 访问成功标志
     * @param error 失败标志
     */
    public void getIdentifyingCode(String phone, String code, final Handler handler, final int success, final int error) {
        RequestParams params = new RequestParams(HttpUrlUtil.SECCODESEND);
