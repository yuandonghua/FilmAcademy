...
package starpark.filmacademy.view.tab;
 ...
 * <p>
 * <p>You can also add items to TabLayout in your layout through the use of {@link }.
...
public class TabLayout extends HorizontalScrollView {
    ...
    //默认icon和text的间距
    private static final int DEFAULT_GAP_TEXT_ICON = 10; // dps
    ...
    private int TabView_HORIZONTAL = 0;

    /**
     * @description:设置TabView中icon和text是垂直还是水平对齐
     * @author:袁东华 created at 2016/7/13 0013 下午 6:03
     */
    public void setOrientation(int TabView_HORIZONTAL) {
        this.TabView_HORIZONTAL = TabView_HORIZONTAL;
    }

    /**
     * @description:自定义TabView
     * @author:袁东华 created at 2016/7/13 0013 下午 5:59
     */
    class TabView extends LinearLayout implements OnLongClickListener {
        ...
        public TabView(Context context) {
            ...
            setOrientation(TabView_HORIZONTAL);
            setClickable(true);
        }
...
//                }
    ...
    /**
     * @description:获取TabLayout默认的高度
     * @author:袁东华 created at 2016/7/13 0013 下午 5:52
     */
    private int getDefaultHeight() {
        ...
        return hasIconAndText && !restrainHeight ? DEFAULT_HEIGHT_WITH_TEXT_ICON : DEFAULT_HEIGHT;
    }

    //默认外界不约束宽度
    public boolean restrainHeight = false;

    /**
     * @description:外界是否约束高度
     * @author:袁东华 created at 2016/7/13 0013 下午 5:55
     */
    public void restrainHeight(boolean restrainHeight) {
        this.restrainHeight = restrainHeight;
    }
...
//    public static int selectTabPosition = 0;
//    //tab的图标
//    private int[] tabImage = null;
//
//    public void setImages(int[] tabImage) {
